"""
Get all variable types from d_items which linksto chartevents, category is labs, routine vital signs and param_type is
numeric
"""
...
def identify_item_ids():
    ...
    labs_and_vitals = all_chart_events[all_chart_events["category"].isin(["Routine Vital Signs", "Respiratory",
                                                                          "Labs"])]
